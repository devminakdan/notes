...
import com.minakdan.notes_api.jooq.keys.DATABASECHANGELOGLOCK_PKEY
...
open class Databasechangeloglock(
     ...
     */
    override fun where(condition: Condition?): Databasechangeloglock = Databasechangeloglock(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Databasechangeloglock = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Databasechangeloglock = where(DSL.notExists(select))
}
