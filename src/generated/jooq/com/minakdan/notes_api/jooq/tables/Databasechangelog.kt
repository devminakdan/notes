...
import com.minakdan.notes_api.jooq.tables.records.DatabasechangelogRecord
...
open class Databasechangelog(
     ...
     */
    override fun where(condition: Condition?): Databasechangelog = Databasechangelog(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Databasechangelog = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Databasechangelog = where(DSL.notExists(select))
}
